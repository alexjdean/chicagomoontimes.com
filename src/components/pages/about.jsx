...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <p style={textStyle}>In all seriousness, the Moon-Times was created in April 2022 by a bored computer programmer on a Saturday night. Everything on the site is satire. Please don't sue me!</p>
    </div>
  );
};
